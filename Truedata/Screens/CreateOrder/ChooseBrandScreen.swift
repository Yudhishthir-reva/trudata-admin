...
private struct BrandSelectionRow: View {
...
private struct TopSellingSuggestionRow: View {
...
private struct TopSellingSuggestionPlaceholderRow: View {
    var body: some View {
        HStack(spacing: 12) {
            RoundedRectangle(cornerRadius: 8, style: .continuous)
...
private struct LabelDotText: View {
    let color: Color
    let text: String
